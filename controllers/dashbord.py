...
class BackendController(http.Controller):
    ...
    def api_dashboard(self, **kw):
        ...
        def get_res_data(unite_id):
            ...
            if unite_id.children_ids:
                res['childs']=[]
                for child_id in unite_id.children_ids:
                    res['childs'].append(get_res_data(child_id))
        ...
        for unite_id in unite_ids:
            res_data.append(get_res_data(unite_id))
        response_json = json.dumps(res_data, default=datetime_serializer)
        print("response_is")
        # print(response_json)
